...
with open('/Users/vedansh/Desktop/matcherc.app/src/screens/main/brand/BrandSwipeScreen.tsx', 'r') as f:
    content = f.read()
...
with open('/Users/vedansh/Desktop/matcherc.app/src/screens/main/brand/BrandSwipeScreen.tsx', 'w') as f:
    f.write(content)

print("Migration applied for BrandSwipeScreen!")
